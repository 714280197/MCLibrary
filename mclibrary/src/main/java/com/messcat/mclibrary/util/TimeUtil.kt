 ...
 * @return
 */
fun getTodayDateTime(time: Long): String {
 ...
 * 转换歌曲的时间
 */
fun getMusicTime(time: Long): String {
 ...
 * @return
 */
fun getYearDate(time: Long): String {
 ...
 * @return
 */
fun getMonthEndDay(time: String): String? {
 ...
 * @return
 */
fun timeDifference(nowtime: String, endtime: Long): Long {
...
fun getSystemTime(): String {
    val formatter = SimpleDateFormat(COM)
